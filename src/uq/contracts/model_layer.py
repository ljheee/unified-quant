...
_RESEARCH_IDENTITY_EXCLUDED_FIELDS = {
    ...
    "research_run_request_v3": {"request_content_generation_id", "manifest_digest_sha256", *_RUN_LOCAL_FIELDS},
...
def research_stage_plan_v3_sha256() -> str:
    """Return the externally reviewed Research Chain stage-plan v3 digest."""
    return sha256_json({
        "schema_version": "v3",
        "stage_plan": [
            "resolve_request",
...
def research_contract_identities(
    ...
    *,
    ...
    if schema_name == "model_definition_template":
        ...
        content_field, digest_field = "template_generation_id", "template_manifest_digest_sha256"
    elif schema_name in {"research_run_request", "research_run_request_v2", "research_run_request_v3"}:
...
class ModelContractLoader:
    ...
    def validate(schema_name: str, payload: dict[str, Any]) -> None:
        ...
        if schema_name in _RESEARCH_SCHEMA_NAMES:
            _reject_non_finite(payload)
            validate_contract(
                f"{schema_name}.json" if schema_name in {"research_run_request_v2", "research_run_request_v3"}
            ...
            content_field = {
                ...
                "research_run_request_v3": "request_content_generation_id",
            ...
            digest_field = {
                ...
                "research_run_request_v3": "manifest_digest_sha256",
