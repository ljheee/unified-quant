...
Implemented release acceptance sub-items now have executable runtime evidence. Remaining release gates are broader cross-platform certification for F4; factor-v1 quality binding now has executable missing, mismatch, tamper, failed-report, and read-path evidence.
