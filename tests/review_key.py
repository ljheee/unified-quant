...
def _ensure_v3_test_reviewer_key() -> Path:
    path = Path(tempfile.gettempdir()) / "uq-test-reviewer-ed25519-v3-private.pem"
...
REVIEWER_V3_PRIVATE_KEY = _ensure_v3_test_reviewer_key()
